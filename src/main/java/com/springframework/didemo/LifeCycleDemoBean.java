...
public class LifeCycleDemoBean implements InitializingBean, DisposableBean,
    ...
    public void preDestroy() {
        System.out.println("The preDestroy annptated method has been called");
    }

    public void beforeInit() {
        System.out.println("The beforeInit method has been called by the Bean Post Processor");
    }

    public void afterInit() {
        System.out.println("The afterInit method has been called by the Bean Post Processor");
    }
}
